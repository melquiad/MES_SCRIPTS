...
SELECT g3f.npp, g3d.numa, g3a.a, g3a.espar, g3d.age13, g3d.age13, g3d.longcar, g3d.ncerncar, e2p.auteurlt, g3d.typdom, g3a.c13, g3f.incref
FROM inv_exp_nm.g3foret g3f
...
--SELECT * FROM calcul_age WHERE npp = '18-22-041-1-126T';
--SELECT * FROM inv_exp_nm.g3agedom WHERE npp = '18-22-041-1-126T' ORDER BY numa;
--DELETE FROM inv_exp_nm.g3agedom WHERE npp = '18-22-041-1-126T' AND numa IN (5, 6);


INSERT INTO ages (npp, age_1, espar_age_1, qage, incref)
SELECT c1.npp, AVG(c1.age), c1.espar, 'MS', c1.incref
FROM calcul_age c1
...
FROM (
	SELECT c1.npp, AVG(c1.age) AS age, c1.espar
	FROM calcul_age c1
