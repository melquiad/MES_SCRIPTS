/*
-- liste des données valides sur la campagne 2023 en base de production, points nouveaux
...
-- liste des données 1re visite arrêtées fin campagne 2022
SELECT f.pformat, c.donnee
FROM metaifn.afchamp c
INNER JOIN metaifn.afformat f USING (famille, format)
WHERE f.famille = 'INV_PROD'
...
-- liste des données 1re visite apparues à la campagne 2023
SELECT f.pformat, c.donnee
FROM metaifn.afchamp c
INNER JOIN metaifn.afformat f USING (famille, format)
WHERE f.famille = 'INV_PROD'
...
-- liste des données 2ème visite arrêtées fin campagne 2022
SELECT f.pformat, c.donnee
FROM metaifn.afchamp c
INNER JOIN metaifn.afformat f USING (famille, format)
WHERE f.famille = 'INV_PROD'
...
-- liste des données 2ème visite  apparues à la campagne 2023
SELECT f.pformat, c.donnee
FROM metaifn.afchamp c
INNER JOIN metaifn.afformat f USING (famille, format)
WHERE f.famille = 'INV_PROD'
...
-- liste des données 1ère visite dont l'unité a changé en 2023
WITH change_unit AS (
...
-- liste des données 2ème visite dont l'unité a changé en 2023
WITH change_unit AS (
    SELECT f.pformat, d.donnee, d.unite, i.incref, i.dcunite, d.libelle
    , lag(dcunite, 1) OVER(PARTITION BY f.pformat, d.donnee ORDER BY i.incref) AS dcunite_avant
    FROM metaifn.addonnee d
...
INSERT INTO inv_prod_new.description (id_ech, id_point, dc, incid, peupnr, sver, nincid, href_dm, caracthab, tplant, suppl, qual_data)
...
WHERE v1.annee = 2023
AND (vp.dc, vp.incid, vp.peupnr, vp.sver, vp.nincid, vp.href_dm, vh.ligneriv, vp.cam, vp.entp, vh.caracthab) IS DISTINCT FROM (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
WITH quals AS(
    ...
    INNER JOIN inv_prod_new.v_liste_points_lt1 v1 ON q.npp = v1.npp
    WHERE v1.annee = 2023
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('DC', 'INCID', 'PEUPNR', 'SVER', 'NINCID', 'HREF_DM', 'CARACTHAB', 'CAM', 'LIGNERIV', 'ENTP')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
------------------------------------------------------------------------------------------------------------------------
-- Table ARBRE
INSERT INTO inv_prod_new.arbre (id_ech, id_point, a, c13_mm)
...
------------------------------------------------------------------------------------------------------------------
-- Table RECO_2015
INSERT INTO inv_prod_new.reco_2015 (id_ech, id_point, utip, bois, doute_bois, autut, tauf, tform, eflt, qbois)
SELECT v2.id_ech, v2.id_point, vp2.utip5, vp2.bois5, vp2.doute_bois5, vp2.autut5, vp2.tauf5, vp2.tform5, vp2.eflt5, vp2.qbois5
FROM soif.v2e4point vp2
INNER JOIN states ps ON vp2.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp2.npp = v2.npp
WHERE v2.annee = 2023
AND (vp2.utip5, vp2.bois5, vp2.doute_bois5, vp2.autut5, vp2.tauf5, vp2.tform5, vp2.eflt5, vp2.qbois5) 
    IS DISTINCT FROM (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format LIKE 'TV2%'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('UTIP5', 'BOIS5', 'DOUTE_BOIS5', 'AUTUT5', 'TAUF5', 'TFORM5', 'EFLT5', 'QBOIS5')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
----------------------------------------------------------------------------------------------------------------------------
-- Table DESCRIPTION
INSERT INTO inv_prod_new.description (id_ech, id_point, dc, incid, peupnr, sver, nincid, caracthab, evo_tplant)
SELECT v2.id_ech, v2.id_point, dc5, incid5, peupnr5, sver5, nincid5, vh.caracthab, evo_tplant5
...
WHERE v2.annee = 2023
AND (dc5, incid5, peupnr5, sver5, nincid5, evo_tplant5, caracthab, cam, ligneriv) IS DISTINCT FROM (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO inv_prod_new.description (id_ech, id_point, dc, incid, peupnr, sver, nincid, href_dm, caracthab, suppl)
SELECT v2.id_ech, v2.id_point, vp.dc, vp.incid, vp.peupnr, vp.sver, vp.nincid, vp.href_dm, vh.caracthab
, CASE 
    WHEN (vp.cam, vh.ligneriv, vp.entp) IS DISTINCT FROM  (NULL, NULL, NULL) THEN JSONB_STRIP_NULLS(jsonb_build_object('cam', vp.cam) || jsonb_build_object('ligneriv', vh.ligneriv) || jsonb_build_object('entp', vp.entp))
    ELSE NULL
  END AS suppl
...
WHERE v2.annee = 2023
AND (vp.dc, vp.incid, vp.peupnr, vp.sver, vp.nincid, vp.href_dm, vh.caracthab, vh.ligneriv, vp.cam, vp.entp) IS DISTINCT FROM (NULL, NULL, null, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format LIKE 'TV2%'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('DC5', 'INCID5', 'PEUPNR5', 'SVER5', 'NINCID5', 'CARACTHAB')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
WITH quals AS(
    ...
    INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON q.npp = v2.npp
    WHERE v2.annee = 2023
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('DC', 'INCID', 'PEUPNR', 'SVER', 'NINCID', 'HREF_DM', 'CARACTHAB', 'LIGNERIV', 'CAM', 'ENTP')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
------------------------------------------------------------------------------------------------------------------------------------------------
-- Table DESCRIPT_M2
INSERT INTO inv_prod_new.descript_m2 (id_ech, id_point, nlisi5, instp5)
SELECT v2.id_ech, v2.id_point, nlisi5, instp5
FROM soif.v2e5point5 vp
INNER JOIN states ps ON vp.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (nlisi5, instp5) IS DISTINCT FROM (NULL, NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format LIKE 'TV2%'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('NLISI5', 'INSTP5')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
INSERT INTO inv_prod_new.descript_m1 (id_ech, id_point, plisi, cslisi, dist, gest, integr, iti, portance, asperite, pentexp, andain, plas25, plas15, deppr, bord, orniere, tcat10, azdep_gd, ddep_cm)
SELECT v2.id_ech, v2.id_point, plisi, cslisi, dist, gest, integr, iti, portance, asperite, pentexp, andain::boolean, plas25, plas15, deppr, bord, orniere, tcat10, azdep_gd, ddep_cm
FROM soif.v2e5point vp
LEFT JOIN soif.v2e5habitat vh ON vp.npp = vh.npp
INNER JOIN states ps ON vp.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (plisi, cslisi, dist, gest, integr, iti, portance, asperite, pentexp, andain, plas25, plas15, deppr, bord, orniere, tcat10, azdep_gd, ddep_cm) 
    IS DISTINCT FROM (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (pbuis, atpyr) IS DISTINCT FROM (NULL, NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format LIKE 'TV2%'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('PBUIS', 'ATPYR')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
-----------------------------------------------------------------------------------------------------------------------
-- Table PLANTATIONS
INSERT INTO inv_prod_new.plantations (id_ech, id_point, bplant_dm, iplant_dm, tpespar1, tpespar2)
SELECT v2.id_ech, v2.id_point, bplant5_dm, iplant5_dm, tpespar15, tpespar25
FROM soif.v2e5point5 vp
INNER JOIN states ps ON vp.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (bplant5_dm, iplant5_dm, tpespar15, tpespar25) IS DISTINCT FROM (NULL, NULL, NULL, NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format LIKE 'TV2%'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('TPESPAR15', 'TPESPAR25', 'BPLANT5_DM', 'IPLANT5_DM')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
-- Table ARBRE
INSERT INTO inv_prod_new.arbre (id_ech, id_point, a, c13_mm)
SELECT v2.id_ech, v2.id_point, a, c135_mm
...
-- Table ARBRE_M1_2014
INSERT INTO inv_prod_new.arbre_m1_2014 (id_ech, id_point, a, deggib, ddec_cm, mes_c13, hcd_cm)
SELECT v2.id_ech, v2.id_point, a, deggib, ddec_cm, mes_c13, hcd_cm
FROM soif.v2e5arbre vp
INNER JOIN states ps ON vp.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (deggib, ddec_cm, mes_c13, hcd_cm) IS DISTINCT FROM (null, NULL, NULL, NULL)
UNION
SELECT v2.id_ech, v2.id_point, a, NULL AS deggib, ddec_cm AS ddec_cm, mes_c13, NULL AS hcd_cm
FROM soif.v2e5arbre_new5 vp
INNER JOIN states ps ON vp.npp = ps.npp AND ps.state >= 'E'
INNER JOIN inv_prod_new.v_liste_points_lt2 v2 ON vp.npp = v2.npp
WHERE v2.annee = 2023
AND (mes_c13) IS DISTINCT FROM (NULL);
...
WITH quals AS(
    ...
    WHERE v2.annee = 2023
    AND q.format = 'TV2E5ARBRE'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('DEGGIB', 'DDEC_CM', 'MES_C13')
    UNION 
    SELECT v2.id_ech, v2.id_point, a
    , JSONB_STRIP_NULLS(jsonb_build_object('donnee', RTRIM(COALESCE(f."attribute", q.donnee))) ||  jsonb_build_object('qdonnee', RTRIM(q._donnee)) ||  jsonb_build_object('mode', RTRIM(q.mode)) ||  jsonb_build_object('valeur', q.valeur) ||  jsonb_build_object('mesure', q.mesure) ||  jsonb_build_object('note', q.note)) AS qual_data
    FROM soif.qequalite q
    ...
    WHERE v2.annee = 2023
    AND q.format = 'TV2E5ARBRE_NEW5'
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('MES_C13')
)
, json_final AS (
    SELECT id_ech, id_point, a, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
INNER JOIN inv_prod_new.point_lt pl USING (id_ech, id_point)
WHERE v1.annee = 2023
AND pl.datepoint IS NULL;

SELECT *
FROM states WHERE npp IN ('20-64-160-1-276T', '20-31-193-1-273T', '20-23-184-1-178T');
*/
...
---------------------------------------------------------------------------------------------------------------------------------------------
-- Table RECO_2015
INSERT INTO inv_prod_new.reco_2015 (id_ech, id_point, utip, bois, doute_bois, autut, tauf, tform, eflt, rp, azrp_gd, drp_cm, qbois, vegrp, esprp, c13rp_mm)
...
INNER JOIN inv_prod_new.v_liste_points_lt1_pi2 v1 ON vp2.npp = v1.nppr
WHERE v1.annee = 2023
AND (vp2.utip, vp2.bois, vp2.doute_bois, vp2.autut, vp2.tauf, vp2.tform, vp2.eflt, vp2.rp, vp2.azrp_gd, vp2.drp_cm, vp2.qbois, vp2.vegrp, vp2.esprp, vp2.c13rp_mm) 
    IS DISTINCT FROM (NULL, null, null, null, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
WITH quals AS(
    ...
    INNER JOIN inv_prod_new.v_liste_points_lt1_pi2 v1 ON q.npp = v1.nppr
    WHERE v1.annee = 2023
    AND RTRIM(COALESCE(f."attribute", q.donnee)) IN ('UTIP', 'BOIS', 'DOUTE_BOIS', 'AUTUT', 'TAUF', 'TFORM', 'EFLT', 'RP', 'AZRP_GD', 'DRP_CM', 'QBOIS','VEGRP', 'ESPRP', 'C13RP_MM')
)
, json_final AS (
    SELECT id_ech, id_point, to_jsonb(ARRAY_AGG(qual_data)) AS qual_data
    FROM quals
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Table DESCRIPT_M1 --> suppression de TPLANT et de ABROU, ajout de tcnr, ornr, prnr, dispnr, predom, fouilçi 
-- ALTER TABLE descript_m1 DROP  COLUMN abrou;
-- ALTER TABLE descript_m1 ALTER COLUMN tcnr TYPE varchar(2); --> tcnr est de TYPE varchar(2) dans soif
