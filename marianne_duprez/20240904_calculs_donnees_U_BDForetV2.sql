...
/* ---------- Contrôles ------------------
SELECT count(*) FROM read_csv('/home/lhaugomat/Documents/MES_SCRIPTS/marianne_duprez/ptsi18_utfv.csv');

SELECT count(DISTINCT npp) FROM  read_csv('/home/lhaugomat/Documents/MES_SCRIPTS/marianne_duprez/ptsi18_utfv.csv');
...
SELECT npp , depbdv2 AS u_dep_bdfor, anrefbdv AS u_an_bdfor, codeTFVdis AS u_tfv, LEFT(dist_bdfor,1) AS u_dist_bdfor, 
	...
	END AS u_tfv_in
FROM read_csv('/home/lhaugomat/Documents/MES_SCRIPTS/marianne_duprez/ptsi18_utfv.csv');
*/
...
FROM read_csv('/home/lhaugomat/Documents/MES_SCRIPTS/marianne_duprez/ptsi18_utfv.csv') AS h
WHERE ug.npp = h.npp;
