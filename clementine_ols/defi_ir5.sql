...
, g3a.incref
, CASE WHEN e2p.pro_nm = 'C' THEN '1' ELSE e2p.pro_nm END AS pro
...
, CASE WHEN g.c13_5 < 0.0001 THEN 0 ELSE EXP((c.coef1 + c.coef2 * LN(g.c13_5)+ c.coef3 * (LN(g.c13_5))^2+ c.coef4 * (LN(g.c13_5))^3+ c.coef5 * (LN(g.c13_5))^4) + c.coef6 ^ 2 / 2) END AS v13_5
FROM regroup g
