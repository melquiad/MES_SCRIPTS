...
SELECT * FROM metaifn.ajoutdonnee('DEPER25', NULL, 'DEPER', 'IFN', NULL, 6, 'varchar(1)', 'CC', TRUE, TRUE, 
...
WHERE INCREF BETWEEN 12 AND 17 AND DEPER25 IS NOT NULL
ORDER BY INCREF, NPP;
...
SELECT NPP, INCREF, DEPER25
FROM inv_exp_nm.g3foret
WHERE INCREF = 18 AND DEPER25 IS NOT NULL
ORDER BY INCREF, NPP;
