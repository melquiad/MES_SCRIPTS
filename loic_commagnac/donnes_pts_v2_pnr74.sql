...
select p.id_ech, p.id_point, am.a, am.c13_mm ,am2.veget5 --,am1.dpr_cm ,am1.azpr_gd--,
from pts_v2 p
inner join arbre am using (id_ech,id_point)
left join arbre_m2 am2 on am.id_ech = am2.id_ech and am.id_point = am2.id_point and am.a = am2.a
