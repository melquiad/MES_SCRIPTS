...
/* Le croisement avec le RGE Alti se fait maintenant directement
...
CALL inv_prod_new.croise_rge_alti('public.pts_rge', '{"id_ech", "id_noeud"}', 'geom', 25, 'zp', TRUE);
...
/* Le croisement avec le RGE Alti se fait maintenant directement depuis la table point_ech en fin de tirage
