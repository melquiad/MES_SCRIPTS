...
-- DONNÉES DES POINTS PREMIÈRE VISITE (LT2) (on ne prend que les points avec une description)
SELECT p.idp, vp1.annee, 'LT2' AS visite, round(st_x(m.geom)::NUMERIC, 0) AS xl93, round(st_y(m.geom)::NUMERIC, 0) AS yl93
, pl.datepoint, r.csa
, b.pbuis, b.dpyr, b.anpyr
...
, s.mortb, s.sfgui, s.sfgeliv, s.sfdorge, g.sfcoeur
FROM v_liste_points_lt1 vp1
INNER JOIN point p USING (id_point)
...
, NULL::char(1) AS acci, s.mortb AS mortb5, NULL::char(1) AS sfcoeur
