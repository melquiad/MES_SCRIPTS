...
CREATE OR REPLACE VIEW metaifn.v_habitats
AS WITH RECURSIVE x (unite, mode, hmode, punite, pmode, rang_hab, hab, niveau) AS (
...
GRANT exploitation_datareader TO "IBonheme";
