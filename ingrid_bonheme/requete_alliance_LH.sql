...
LEFT JOIN sous_alliances sa ON h.hab = sa.hab
LEFT JOIN ordres o ON h.hab = o.hab
LEFT JOIN sous_ordres so ON h.hab = so.hab
LEFT JOIN classes c ON h.hab = c.hab
LEFT JOIN sous_classes sc ON h.hab = sc.hab
LEFT JOIN associations ass ON h.hab = ass.hab
