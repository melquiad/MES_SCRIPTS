...
WHERE pe.dep IN ('06','48','83','88') AND vlpl.annee BETWEEN 2015 AND 2023
UNION
SELECT vlpl.npp, p.idp, pe.dep, vlpl.annee, round(st_x(p.geom)::NUMERIC) AS xl93,  round(st_y(p.geom)::NUMERIC) AS yl93
...
SELECT ep2.npp, ep2.dep, ep2.incref + 2005 AS annee, ROUND(ST_X(ec.geom)::NUMERIC) AS xl93, ROUND(ST_Y(ec.geom)::NUMERIC) AS yl93
FROM  inv_exp_nm.e2point ep2
INNER JOIN inv_exp_nm.e1coord ec ON ep2.npp = ec.npp
WHERE incref BETWEEN 14 AND 18 AND dep IN ('06','48','83','88');
