...
cd /home/lhaugomat/Documents/GITLAB/production/Campagne_2025/donnees/livrables2025

sed -i "s/'//g" points2025.csv
sed -i "s/'//g" lhf2025.csv
...
\COPY public.resultats FROM '/home/lhaugomat/Documents/GITLAB/production/Campagne_2025/donnees/livrables2025/points2025.csv' WITH CSV HEADER DELIMITER '|' NULL AS ''
...
\COPY public.inters FROM '/home/lhaugomat/Documents/GITLAB/production/Campagne_2025/donnees/livrables2025/lh2025.csv' WITH CSV HEADER DELIMITER '|' NULL AS ''
...
INNER JOIN inv_prod_new.campagne c ON e.id_campagne = c.id_campagne AND c.millesime = 2025
...
/*
/*************************************************************************************
 * Chargement de la densification de PI                                              *
 ************************************************************************************
...
\COPY public.resultats FROM '/home/ign.fr/CDuprez/Documents/DBeaver/workspace/SQL/production/Incref19/donnees/densif_pi2024.csv' WITH CSV HEADER DELIMITER '|' NULL AS ''
