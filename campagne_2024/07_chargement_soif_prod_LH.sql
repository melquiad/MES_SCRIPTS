/*
-- liste des données valides sur la campagne 2024 en base de production, points nouveaux
...
-- liste des données 1ère visite dont l'unité a changé en 2024
WITH change_unit AS (
...
-- points PI2 LT1SELECT v1.id_ech, v1.id_point, vp2.npp, pd.echelon, vp2.datepoint, vp2.reco, vp2.datereco, vp2.qreco
