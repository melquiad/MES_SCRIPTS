...
INNER JOIN inv_prod_new.point_m2 pm USING (id_ech, id_point)
INNER JOIN inv_exp_nm.e2point ep USING (npp)
WHERE v.annee between 2010 AND 2024
AND ep.leve = '1'
AND ep.us_nm IN ('1', '5') AND pointok5 != '0'
GROUP BY incref
...
AND millesime BETWEEN 2010 AND 2024
AND EXISTS (
