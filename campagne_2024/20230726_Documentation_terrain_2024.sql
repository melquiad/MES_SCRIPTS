...
INSERT INTO metaifn.aiunite (usite, site, cyc, incref, inv, unite, dcunite)
SELECT 'P', 'F', '5', 15, 'T', 'QRECO', 'QRECO'
UNION
SELECT 'P', 'F', '5', 16, 'T', 'QRECO', 'QRECO'
UNION 
SELECT 'P', 'F', '5', 17, 'T', 'QRECO', 'QRECO'
UNION 
SELECT 'P', 'F', '5', 18, 'T', 'QRECO', 'QRECO1'
UNION 
SELECT 'P', 'F', '5', 19, 'T', 'QRECO', 'QRECO1'
UNION 
SELECT 'P', 'F', '5', 20, 'T', 'QRECO', 'QRECO1';
--ou plus élégant
INSERT INTO metaifn.aiunite (usite, site, cyc, incref, inv, unite, dcunite)
SELECT 'P', 'F', '5', i, 'T', 'QRECO', CASE WHEN i < 18 THEN 'QRECO' ELSE 'QRECO1' END 
FROM generate_series(15, 20) i
ORDER BY i;
