...
---------------------------------------------------------------------------------------------
-- Création du champ dans la table
...
SELECT incref, tgb_onb, count(tgb_onb)
FROM inv_exp_nm.g3arbre
GROUP BY incref, tgb_onb
ORDER BY incref DESC;

SELECT incref, count(u_tgb_onb)
FROM inv_exp_nm.g3arbre
GROUP BY incref
ORDER BY incref DESC;

SELECT incref, tgb_onb, count(u_tgb_onb)
FROM inv_exp_nm.g3arbre
GROUP BY incref, tgb_onb
ORDER BY incref DESC;
