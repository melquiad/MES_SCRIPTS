...
'Partition idéalisée et régionalisée de la composition', 'Partition idéalisée et régionalisée de la composition en espèces ligneuses des forêts françaises');
	...
	-- partie champ
SELECT * FROM metaifn.ajoutchamp('COMP_IDREG', 'G3FORET', 'INV_EXP_NM', FALSE, 0, 19, 'bpchar', 4);
SELECT * FROM metaifn.ajoutchamp('COMP_IDREG', 'P3POINT', 'INV_EXP_NM', FALSE, 0, 19, 'bpchar', 4);
...
where u_comp_idreg IS NOT NULL
GROUP BY incref
ORDER BY incref DESC;
