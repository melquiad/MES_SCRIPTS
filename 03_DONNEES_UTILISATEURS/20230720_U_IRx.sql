...
SELECT p.npp, a1.a, ac1.irn_1_10_mm / 10000.0 AS ir1, ac2.irn_1_10_mm / 10000.0 AS ir2
    ...
    LEFT JOIN accroissement ac4 ON a1.id_ech = ac4.id_ech AND a1.id_point = ac4.id_point AND a1.a = ac4.a AND ac4.nir = 4
    WHERE r.csa != '5'
    AND c.millesime = 2022
    AND COALESCE(ac1.a, ac2.a, ac3.a, ac4.a) IS NOT NULL;

	-- dans test-inv-exp : on crée une table temporaire accroiss puis on y copie le fichier accroiss.csv
CREATE TABLE public.accroiss
(
	npp CHAR(16),
	a SMALLINT,
	ir1 REAL,
	...
	--depuis un psql local
\COPY public.accroiss FROM '/home/lhaugomat/Documents/EXPORTS/accroiss.csv' WITH CSV HEADER DELIMITER ';' NULL AS 'NULL'
...
-- mise à jour sur campagne 2024

       -- dans inv-dev on exporte cette selection dans un fichier accroiss.csv
DROP TABLE public.accroiss_2024;
...
\COPY (SELECT p.npp, a1.a, ac1.irn_1_10_mm / 10000.0 AS ir1, ac2.irn_1_10_mm / 10000.0 AS ir2
    ...
    AND COALESCE(ac1.a, ac2.a, ac3.a, ac4.a) IS NOT NULL) TO '/home/lhaugomat/Documents/ECHANGES/EXPORTS_DIVERS/accroiss_2024.csv' WITH CSV HEADER DELIMITER ';' NULL AS '';
...
(
	...
	--depuis un psql local
\COPY public.accroiss FROM '/home/lhaugomat/Documents/ECHANGES/EXPORTS_DIVERS/accroiss_2024.csv' WITH CSV HEADER DELIMITER ';' NULL AS 'NULL'
