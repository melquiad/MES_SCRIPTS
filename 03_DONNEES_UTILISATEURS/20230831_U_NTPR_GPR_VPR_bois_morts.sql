...
INNER JOIN inv_exp_nm.u_e2point u2 ON e2p.npp = u2.npp
WHERE u3.npp = g3m.npp AND u3.a = g3m.a
AND e2p.incref BETWEEN 6 AND 12;
...
************************************************************************************************************/
SELECT * FROM metaifn.ajoutchamp('U_NTPR'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_NTPR'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_NTPR');

SELECT * FROM metaifn.ajoutchamp('U_NTPR_AN'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_NTPR_AN'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_NTPR_AN');
-----------------------------------------------------------------------

SELECT * FROM metaifn.ajoutchamp('U_GPR'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_GPR'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_GPR');

SELECT * FROM metaifn.ajoutchamp('U_GPR_AN'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_GPR_AN'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_GPR_AN');
-----------------------------------------------------------------------------

SELECT * FROM metaifn.ajoutchamp('U_VPR'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_VPR'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_VPR');

SELECT * FROM metaifn.ajoutchamp('U_VPR_AN'::varchar, 'U_G3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);
SELECT * FROM metaifn.ajoutchamp('U_VPR_AN'::varchar, 'U_P3MORTS'::varchar, 'INV_EXP_NM'::varchar, FALSE::boolean, 6::int4, NULL::int4, 'float8'::varchar, NULL::int4, NULL::int4, FALSE::boolean, 'lhaugomat'::varchar);

INSERT INTO utilisateur.autorisation_groupe_donnee(groupe, donnee) 
VALUES ('FLUX', 'U_VPR_AN');
